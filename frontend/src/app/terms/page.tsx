  ...
  return (
    <div className="flex min-h-dvh flex-col">
      <main className="mx-auto w-full max-w-3xl flex-1 px-5 py-14 sm:px-8">
        ...
        <h1 className="mt-6 text-2xl font-semibold tracking-tight">{TERMS.title}</h1>
        <p className="mt-2 text-sm text-muted-foreground">{TERMS.summary}</p>

        <PolicyBody policy={TERMS} />
